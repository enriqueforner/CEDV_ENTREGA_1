...
void MyApp::createScene() {
  ...
  node1Bajo-> scale(2.5,2.5,2.5);
  //node1Bajo -> setPosition(-45,0,55);
  node1Bajo -> setPosition(-53,23,55);
  node1Bajo -> yaw(Ogre::Degree(2.4));
  node1Bajo -> pitch(Ogre::Degree(45));
  
  node1Alto->  scale(2.5,2.5,2.5);
  //node1Alto -> setPosition(-47,6,-2);
  node1Alto -> setPosition(3.2,24,55);
  node1Alto -> yaw(Ogre::Degree(2.4));
  node1Alto -> pitch(Ogre::Degree(45));
